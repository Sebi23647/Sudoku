...
//        // Row-based hidden single
//        for (int r = 0; r < 9; ++r) {
//            for (int n = 1; n <= 9; ++n) {
//                int count = 0, lastC = -1;
//                for (int c = 0; c < 9; ++c) {
//                    if (game.getCellState(r, c) == CellState::EMPTY && isSafeCandidate(game, r, c, n)) {
//                        ++count; lastC = c;
//                    }
//                }
//                if (count == 1) {
//                    Hint h; h.row = r; h.col = lastC; h.value = n; h.type = HintType::HiddenSingle;
//                    h.message = "Hidden Single (row): cifra " + std::to_string(n) + " apare doar o data disponibila in randul " + std::to_string(r);
//                    return h;
//                }
//            }
//        }
//        // Column-based hidden single
//        for (int c = 0; c < 9; ++c) {
//            for (int n = 1; n <= 9; ++n) {
//                int count = 0, lastR = -1;
//                for (int r = 0; r < 9; ++r) {
...
//                    h.message = "Hidden Single (column): cifra " + std::to_string(n) + " apare doar o data disponibila in coloana " + std::to_string(c);
//                    return h;
//                }
//            }
//        }
//        // Box-based hidden single
...
//                        h.message = "Hidden Single (box): cifra " + std::to_string(n) + " apare o singura data disponibila in box";
//                        return h;
//                    }
//                }
//            }
